...
export default function AdminDashboard() {
  ...
  if (loading) return <div className="p-10 text-center text-xl font-semibold">Loading Admin Dashboard...</div>;
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <p className="text-gray-500">Welcome back. Here is what is happening in Smart Nutrition.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-4xl font-bold text-blue-600 mt-2">{data?.totalUsers || 0}</p>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            <h3 className="text-gray-500 text-sm font-medium uppercase tracking-wider">Meals Logged</h3>
            <p className="text-4xl font-bold text-green-600 mt-2">{data?.totalMealsLogged || 0}</p>
          </div>
                    ...
                    <tr key={log._id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 text-sm font-medium text-gray-800">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs ${
                          log.action.includes('SIGNUP') ? 'bg-green-100 text-green-700' : 
